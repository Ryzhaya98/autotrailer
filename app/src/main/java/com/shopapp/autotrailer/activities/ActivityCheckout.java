package com.shopapp.autotrailer.activities;
...
import com.shopapp.autotrailer.utilities.DBHelper;
import com.shopapp.autotrailer.utilities.SharedPref;
...
import static com.shopapp.autotrailer.utilities.Constant.GET_SHIPPING;
import static com.shopapp.autotrailer.utilities.Constant.POST_ORDER;
...
public class ActivityCheckout extends AppCompatActivity {
    ...
    DatePicker dp_date_booking;
    TextView tv_date_booking;
    Calendar booking_date =Calendar.getInstance();




    String str_name, str_email, str_phone, str_address, str_shipping, str_order_list, str_order_total, str_comment, str_date_booking;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dp_date_booking = findViewById(R.id.dp_date_booking);
        tv_date_booking= findViewById(R.id.tv_date_booking);
    ...
    public void getDateBooking(){
        dp_date_booking.init(booking_date.get(Calendar.YEAR), booking_date.get(Calendar.MONTH), booking_date.get(Calendar.DAY_OF_MONTH), new DatePicker.OnDateChangedListener() {
            @Override
            public void onDateChanged(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                tv_date_booking.setText(view.getYear() + "-" + (view.getMonth()+1) +  "-" +  view.getDayOfMonth() );
            }
        });
    ...
    public void getValueFromEditText() {
        ...
        str_date_booking = tv_date_booking.getText().toString();
        Log.d("BOOKING", str_date_booking);
        ...
        if (str_name.equalsIgnoreCase("") ||
                ...
                str_date_booking.equalsIgnoreCase("") ||
    ...
    public void requestAction() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, POST_ORDER, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("booking_date", str_date_booking);
